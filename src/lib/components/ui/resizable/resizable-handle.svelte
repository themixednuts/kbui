...
>
	{#if withHandle}
		<div
			class="bg-border z-10 flex h-6 w-1 shrink-0 rounded-lg in-data-[direction=vertical]:rotate-90"
		></div>
	{/if}
</ResizablePrimitive.PaneResizer>
